                            ...
                            <div class="datatable table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        include "koneksi.php";
                                        $nomor = 0;
                                        $result = mysqli_query($connect,"SELECT * FROM normal, alternatifhp WHERE normal.Id_mobil=alternatifhp.Id_mobil") or die (mysqli_error($connect));
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="normalisasi_edit.php?Id_mobil=<?php echo $data['Id_mobil']; ?>" title="Edit"><button type="button" class="btn btn-primary">Ubah</button></a>
                                                    </td>
                                                    <td>
