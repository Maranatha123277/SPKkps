        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                if (isset($_POST['Submit'])) {
                    ...
                    $result = mysqli_query($connect, "INSERT INTO alternatifhp(Id_mobil, Nama, kategori_kendaraan, Transmisi, Kisaran_harga_beli,
                            Kapasitas_Penumpang, Kapasitas_Bagasi, Tahun_Pembuatan, Warna_Mobil, Kondisi_Mesin, Bahan_Bakar, Ukuran_CC ) VALUES('','$nama','$ktg','$trs',
                            '$ksb','$kp','$kb','$tp','$wb','$km','$bb','$uc')");
