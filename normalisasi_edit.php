                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                                    ...
                                    <table width="25%" border="0">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                $result = mysqli_query($connect, "SELECT * FROM normal WHERE Id_mobil='$Id_mobil'") or die(mysqli_error($connect));
                                                $data1 = mysqli_fetch_array($result);
                                                ?>
                                                <input type="text" name="idmobil" required class="form-control" value="<?php echo $data1['Id_mobil'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                            ...
                            if (isset($_POST['Submit'])) {
                                ...
                                $result = mysqli_query($connect, "UPDATE normal SET kategori_kendaraan2='$kategori', Transmisi2='$transmisi', Kisaran_harga_beli2='$harga', Kapasitas_Penumpang2='$penumpang', Kapasitas_Bagasi2='$bagasi', Tahun_Pembuatan2='$tahun', Warna_Mobil2='$warna', Kondisi_Mesin2='$kondisi', Bahan_Bakar2='$bahan', Ukuran_CC2='$cc' WHERE Id_mobil='$id'") or die(mysqli_error($connect));

                                // Show message when user added
                                echo "<script>
                                alert('Data Update successfully');
                                window.location.href='http://localhost/php-spk_saw_pemilihan_mobil/normalisasi.php';
                                </script>";
                            }
                            ?>
                            <!-- /. PAGE INNER  -->
