                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="alternatif_edit.php?Id_mobil=<?php echo $data['Id_mobil']; ?>" title="Edit"><button type="button" class="btn btn-primary">Ubah</button></a>
                                            </td>
                                            
                                            <td>
                                                <a href="alternatif_hapus.php?Id_mobil=<?php echo $data['Id_mobil']; ?> "><button type="button" class="btn btn-danger">Hapus</button></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
